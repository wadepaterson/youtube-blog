...
<body>
  ...
  <div class="container container--wide">
    ...
    <div class="cta-cards">
      ...
      <a href="/impromptu-roulette.html" class="cta-card">
        <div class="cta-card__icon">
          <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <circle cx="20" cy="20" r="17" stroke="#7B2FBE" stroke-width="2"/>
            <line x1="20" y1="3" x2="20" y2="20" stroke="#7B2FBE" stroke-width="2" stroke-linecap="round"/>
            <line x1="20" y1="20" x2="32.1" y2="26.5" stroke="#7B2FBE" stroke-width="2" stroke-linecap="round"/>
            <line x1="20" y1="20" x2="7.9" y2="26.5" stroke="#7B2FBE" stroke-width="2" stroke-linecap="round"/>
            <line x1="20" y1="20" x2="32.1" y2="13.5" stroke="#7B2FBE" stroke-width="1.2" stroke-linecap="round" stroke-dasharray="2 2"/>
            <line x1="20" y1="20" x2="7.9" y2="13.5" stroke="#7B2FBE" stroke-width="1.2" stroke-linecap="round" stroke-dasharray="2 2"/>
            <circle cx="20" cy="20" r="2.5" fill="#7B2FBE"/>
            <polygon points="20,4 22,9 18,9" fill="#7B2FBE"/>
          </svg>
        </div>
        <div class="cta-card__body">
          <h2 class="cta-card__heading">Impromptu Roulette</h2>
          <p class="cta-card__sub">Random question spinner for spontaneous speakers</p>
        </div>
      </a>
    </div>
    <main>
